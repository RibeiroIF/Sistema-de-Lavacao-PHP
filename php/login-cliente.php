...
<body>
    <div class="container">
        ...
        <div class="enunciado">
          <h2 class="enunciado-titulo"> Espaço para <span class="subtitle">Login do Cliente</span> </h2> <br>
        ...
        <!--Seção principal-->
        <main class="form">
          <form action="login-cliente.php" method="post" id="form-login-cliente">
            <fieldset>
              <legend> Login do Cliente: </legend>
              
              <div class="form-infos">
                <label for="login" class="alinha"> Login: </label>
                <input type="text" name="login" id="login" placeholder="Seu login aqui..."> <br>

                <label for="senha" class="alinha"> Senha: </label>
                <input type="senha" name="senha" id="senha"> <br>

                <input type="checkbox" name="lembrar-login-cliente" id="lembrar-login-cliente">
                <label for="lembrar-login-cliente"> Manter-me Conectado </label> <br>
              </div>

              <button form="form-login-cliente" type="submit" class="button" name="button-login-cliente"> Logar como Cliente </button>
            </fieldset>
          </form>
        </main>
    </div>
    ...
    <footer class="footer">
     ...
     <?php 
      ...
      $objBanco->criarTabelaAdmin($conexao);

      $cliente = new Clientes();

      if(isset($_POST['logar'])){
        $cliente->logar($conexao, $banco->tabelaClientes);
      }
