...
<body>
    <div class="container">
        ...
        <div class="enunciado">
          <h2 class="enunciado-titulo"> Espaço para <span class="subtitle">Login do Administrador</span> </h2> <br>
        ...
        <!--Seção principal-->
        <main class="form">
          <form action="login-admin.php" method="post" id="formLoginAdmin">
            <fieldset>
              <legend> Login do Administrador: </legend>
              ...
              <div class="form-infos">
                ...
                <input type="checkbox" name="lembrar-login-admin" id="lembrar-login-admin">
                <label for="lembrar-login-admin"> Manter-me Conectado </label> <br>
              </div>

              <button form="form-ogin-dmin" type="submit" class="button" name="button-login-admin"> Logar como Administrador </button>
            </fieldset>
          </form>
        </main>
    </div>
